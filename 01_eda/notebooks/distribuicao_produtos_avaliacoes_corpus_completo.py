...
avaliações no corpus completo, com bins mais densos que a versão original.
"""
import pandas as pd
import matplotlib.pyplot as plt

df = pd.read_csv("data/raw/B2W-Reviews01.csv", dtype={"product_id": str})
...
ax.set_title("Distribuição de Produtos por Quantidade de Avaliações", fontsize=14, fontweight="bold", pad=15)
...
fig_path = "01_eda/figures/Distribuição de Produtos por Quantidade de Avaliações.png"
